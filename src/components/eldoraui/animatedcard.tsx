...
import { useMouse } from "@/components/eldoraui/hooks/usemouse";
import { cn } from "@/lib/utils";
import type { MousePosition } from "@/components/eldoraui/hooks/usemouse";
...
export const MainMenusGradientCard = ({
	...
	const [mouse, parentRef] = useMouse() as [
		MousePosition,
